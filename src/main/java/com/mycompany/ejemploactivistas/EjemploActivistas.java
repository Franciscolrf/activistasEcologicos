...
public class EjemploActivistas {
    ...
    public static void main(String[] args) {
        try {
            ...
            */
            //Guardar id cliente en una variable
            Long idCliente = cliente1.getId();

            // Búsqueda de problemas por cliente
            List<Problema> problemasCliente = pdao.buscarProblemasPorCliente(idCliente);
            System.out.println("Problemas del cliente con id " + idCliente);
            for (Problema problema : problemasCliente) {
                System.out.println(problema.toString());
            }
        } catch (Exception ex) {
            Logger.getLogger(EjemploActivistas.class.getName()).log(Level.SEVERE, null, ex);
        }
